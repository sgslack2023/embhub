...
const GoogleDriveSettings: FC = () => {
  ...
  const handleDeleteSingle = (id: number) => {
    Modal.confirm({
      ...
      content: 'Are you sure you want to delete these Google Drive settings?',
      okText: 'Yes, Delete',
      okType: 'danger',
      cancelText: 'Cancel',
      onOk: () => deleteSetting(id),
    });
  };

  const handleDeleteSelected = (selectedIds: React.Key[]) => {
    Modal.confirm({
      title: `Delete ${selectedIds.length} Google Drive Settings`,
      content: `Are you sure you want to delete ${selectedIds.length} selected Google Drive settings?`,
      okText: 'Yes, Delete All',
      okType: 'danger',
      cancelText: 'Cancel',
      onOk: () => {
        selectedIds.forEach((id) => deleteSetting(Number(id)));
      },
    });
  };
  ...
  const deleteSetting = async (id: number) => {
    try {
      ...
      await axios.delete(`${GoogleDriveSettingsUrl}/${id}`, headers);
